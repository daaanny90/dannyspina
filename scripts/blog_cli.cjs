...
program
  .version("1.2.0")
  .description("CLI for generating blog posts and book notes.");
...
Examples:
  $ node ./scripts/blog_cli.cjs new-post
      Creates a new blog post, prompts for post details, and checks out a new branch named after the post.

  $ node ./scripts/blog_cli.cjs new-book
      Creates a new book note and prompts for the book details.
`,
);
