...
{#if showSearch}
  ...
  >
    <div class="search" class:virtual-keyboard={virtualKeyboard}>
      <input
        bind:this={search}
        type="search"
        placeholder="Search"
...
<div class="header">
  ...
  <button class="search-btn" on:click={openSearch}
    ><SearchIcon /> <span class="search-btn-text">Search</span></button
  >
</div>
